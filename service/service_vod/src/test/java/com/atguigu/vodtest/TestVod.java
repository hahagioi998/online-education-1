...
public class TestVod {
    ...
    public static void getPlayUrl() throws ClientException {
        //1.创建初始化对象
        DefaultAcsClient client = InitObject.initVodClient("LTAI5tPNqXrosworh1Dq799b", "6745J4jsAdUpPfX5kVQwCbnjoD3Z5h");
        ...
        request.setVideoId("4607b4ca6f464e1392bd7e2d6da7ec9f");
    ...
    public void uploadVideo(){
        //账号AK信息请填写(必选)
        String accessKeyId = "LTAI5tPNqXrosworh1Dq799b";
        //账号AK信息请填写(必选)
        String accessKeySecret = "6745J4jsAdUpPfX5kVQwCbnjoD3Z5h";
